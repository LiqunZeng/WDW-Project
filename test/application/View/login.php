              ...
              <div class="col-md-8">
                <div class="form-group">
                  <div class="col-md-10 col-md-offset-1">
                    <label class="control-label">UserName</label>
                      <input type="text" class="form-control" name="frist name" placeholder="Name" required="">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-12 text-center">
                    ...
                    <br>
                    <br>
                    <a class="js-scroll-trigger" name="regisetr" href="TwoTypesOfRegister.html">Don't have an account?</a>
                  </div>
                </div>
            </div>
          </fieldset>
